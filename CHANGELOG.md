...
- The faucet now funds its own operator: a mint batch adds a request payable to the operator whenever its balance of the faucet's asset is below the funding threshold, and the resulting P2ID note is consumed by a later batch.
