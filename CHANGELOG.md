...
- The faucet only tracks and consumes the P2ID notes it asked the network to mint for the operator, and only those carrying the chain's fee asset, so notes sent by anyone else are ignored.
