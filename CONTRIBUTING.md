...
- Reporting a [bug](https://github.com/0xMiden/faucet/issues/new?assignees=&labels=bug&projects=&template=1-bugreport.yml)
- Taking part in [discussions](https://github.com/0xMiden/faucet/discussions)
- Submitting a [fix](https://github.com/0xMiden/faucet/pulls)
- Proposing new [features](https://github.com/0xMiden/faucet/issues/new?assignees=&labels=enhancement&projects=&template=2-feature-request.yml)
